...
Common Weakness Enumeration \todo[inline]{Maybe comparsion between my clusters and the CWEs those
	documents are clustered into?}, it is likely that there is some sort of pattern we can find.
...
\begin{itemize}
	...
	\item TF-IDF (Term Frequency-Inverse Document Frequency) vectorization is employed to convert
	      the text descriptions into numerical features. This technique helps capture the importance
...
made graphing and interpreting the outcome of the clustering somewhat awkward. The approach th
